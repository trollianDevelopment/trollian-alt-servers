#AG NOTE:
#   THIS IS THE OLD CONSOLE THAT WAS REMOVED IN MARCH 2023.
#   THIS FILE (console.py) HAS 8EEN ADDED 8ACK AS A TEMPORARY
#   MEASURE TO EXPERIMENT WITH RE-ENA8LING THE CONSOLE FOR
#   IRCOP FUNCTIONS TO 8E FEASI8LE TO CONDUCT ON THE PCL/
#   TROLLIAN CLIENT.
#
#   EXPECT THIS TO 8E CHANGED TO SOMETHING LESS WONKY IN A
#   FUTURE RELEASE.
#   HISTORICAL RELEASE FILES USED COME FROM 2.5.3 UNLESS
#   OTHERWISE SPECIFIED.
#       -arachnidsGripe 11/10/2025


#   First thing I need to do is manually diff out all the
#   missing lines from pesterchum.py and tie them 8ack to
#   this file, I think? I'm not sure, 8ut it's a start, at
#   8are minimum. If this doesn't work, my next 8est option
#   is gonna 8e looking into the li8raries ______ told me
#   to check out. Here goes........ something, I guess.
#       ==> 21:38 CST, NOV. 10 2025 :
#           Okay, adding console.py 8ack into the overall
#   directory structure of the project doesn't just crash
#   the entire project outright when I try to run it as a
#   test. Doesn't let me open the console/doesn't connect
#   me to the console when I try using the keycom8o
#   (CTRL + W) anywhere in the app. Time to try adding a
#   ton of shit 8ack into pesterchum.py, I guess.
#
#       ==> 21:53 CST :
#           I added the "dep" folder from 2.5.3 8ack into
#   /pnc/dep and 8oth of the major issues in console.py
